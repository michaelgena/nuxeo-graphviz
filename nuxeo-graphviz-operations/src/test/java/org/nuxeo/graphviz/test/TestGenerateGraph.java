package org.nuxeo.graphviz.test;
...
import org.nuxeo.graphviz.GenerateGraph;
...
public class TestGenerateGraph {
    ...
    public void testGenerateGraphFromXML() throws Exception {
		...
		gg.generateGraphFromXML("mgena-SANDBOX", graphVizFolderPath, graphVizFolderPath, commandLineExecutorComponent);
		File dot = new File(graphVizFolderPath+File.separator+"input.dot");
